...
function estecapelli_pt_gettext_fallback( $translation, $text, $domain ) {
	...
	if ( null === $strings ) {
		$strings = array(
			...
			'Two techniques. Registered to our name.' => 'Duas técnicas registadas em nosso nome.',
			...
			'I know my hair-loss area' => 'Conheço a zona de queda de cabelo',
			...
			'We trained our AI on the results of more than 15,000 patients. Learning from their success stories, it analyses your condition and guides you to the treatment that fits you best.' => 'Treinámos a nossa IA com os resultados de mais de 15.000 pacientes. Ao aprender com os seus casos de sucesso, analisa a sua situação e orienta-o para o tratamento mais adequado.',
