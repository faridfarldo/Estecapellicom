...
if ( ! function_exists( 'estecapelli_icon' ) ) {
	...
	function estecapelli_icon( $name, $args = array() ) {
		...
		$paths = array(
			...
			'check-double' => '<polyline points="1 12 5.5 16.5 13 9"/><polyline points="9 15 11 17 22 6"/>',
	...
	function estecapelli_patient_stories_localized() {
		...
		$localized = array(
			...
			'it' => array(
				...
				'headline' => "I loro risultati parlano più forte di qualsiasi pubblicità.",
				'lead'     => "Ascolta, con le loro parole, come i pazienti da tutto il mondo raccontano la loro esperienza con Estecapelli, dalla prima consulenza al risultato a lungo termine.",
				'stories'  => array(
					array(
						'key'         => 'federico-p',
						'name'        => 'Federico P.',
					...
					array(
						...
						'technique'   => 'Vita',
						'rating'      => 5,
						'video_id'    => 'w4vvrg7DqUM',
						'poster'      => $img( 'it/giuseppe-c.jpg' ),
						'poster_pos'  => 'center 30%',
						'photo'       => $img( 'it/giuseppe-c.jpg' ),
						'photo_pos'   => 'center 30%',
						'pre_title'   => "Densità frontale e attaccatura naturale disegnata sul viso.",
						'body'        => "Giuseppe è arrivato dall'Italia presso Estecapelli per sottoporsi a un trapianto di capelli con la tecnica Vita. Dopo una consulenza dettagliata e un'attenta analisi dell'area donatrice e delle zone diradate, è stato definito un piano di trattamento personalizzato. L'intervento è stato pianificato concentrando una maggiore densità nella zona frontale e distribuendo gli innesti in modo più leggero e uniforme verso la parte superiore e il vertice. Particolare attenzione è stata dedicata alla progettazione di un'attaccatura naturale e alla corretta direzione dei follicoli, in armonia con i lineamenti del viso e con la struttura dei capelli esistenti. Al termine della procedura, Giuseppe ha ricevuto tutte le indicazioni necessarie per il periodo post-operatorio e ha iniziato il suo percorso di recupero sotto la supervisione del team medico di Estecapelli.",
					),
					array(
						'key'         => 'luigi-r',
						'name'        => 'Luigi R.',
						...
						'technique'   => 'DHI Vita',
						'rating'      => 5,
						'video_id'    => 'jM5t4lwSSIA',
						'poster'      => $img( 'it/luigi-r.jpg' ),
						'poster_pos'  => 'center 42%',
						'photo'       => $img( 'it/luigi-r.jpg' ),
						'photo_pos'   => 'center 42%',
						'pre_title'   => "Attaccatura ricostruita con densità nella zona frontale.",
						'body'        => "Luigi è arrivato dall'Italia presso Estecapelli per sottoporsi a un trapianto di capelli con la tecnica DHI Vita. Dopo una valutazione approfondita dell'area donatrice e delle diverse zone interessate dal diradamento, è stato elaborato un piano di trattamento personalizzato da completare in un'unica sessione. Durante la procedura è stato previsto il prelievo del numero massimo di innesti ottenibile in sicurezza. La priorità è stata assegnata alla zona frontale, dove gli innesti sono stati posizionati con maggiore densità per ricostruire l'attaccatura e migliorare la cornice del viso. Nella zona centrale e nell'area del vertice, i follicoli sono stati distribuiti in modo più leggero e uniforme, in base alla disponibilità degli innesti. Al termine dell'intervento, Luigi ha ricevuto tutte le istruzioni necessarie per il periodo post-operatorio e ha iniziato il suo percorso di recupero con il supporto del team medico di Estecapelli.",
					),
					array(
						'key'         => 'marco-m',
						'name'        => 'Marco M.',
						...
						'technique'   => 'Exosome FUE',
						'rating'      => 5,
						'video_id'    => '3AJ7tX4mdyc',
						'poster'      => $img( 'it/marco-m.jpg' ),
						'poster_pos'  => 'center 38%',
						'photo'       => $img( 'it/marco-m.jpg' ),
						'photo_pos'   => 'center 38%',
						'pre_title'   => "Densità frontale e infoltimento uniforme verso il vertice.",
						'body'        => "Marco è arrivato dall'Italia presso Estecapelli per sottoporsi a un trapianto di capelli con la tecnica Exosome FUE. Dopo un'attenta valutazione dell'area donatrice e delle zone interessate dal diradamento, è stato elaborato un piano di trattamento personalizzato. Durante la procedura è stato previsto il prelievo del massimo numero di innesti ottenibile in sicurezza. Nella zona frontale gli innesti sono stati impiantati con una maggiore densità per migliorare la definizione dell'attaccatura e ottenere un aspetto più naturale. Nella parte superiore e nel vertice è stato pianificato un infoltimento distribuendo gli innesti rimanenti in modo uniforme. Al termine dell'intervento, Marco ha ricevuto tutte le indicazioni necessarie per il periodo post-operatorio e ha iniziato il suo percorso di recupero con il supporto del team medico di Estecapelli.",
					),
					array(
						'key'         => 'michele-m',
						'name'        => 'Michele M.',
						...
						'technique'   => 'Vita',
						'rating'      => 5,
						'video_id'    => 'nD-oDyHRAbE',
						'poster'      => $img( 'it/michele-m.jpg' ),
						'poster_pos'  => 'center 30%',
						'photo'       => $img( 'it/michele-m.jpg' ),
						'photo_pos'   => 'center 30%',
						'pre_title'   => "Zona frontale e tempie infoltite con un'attaccatura armoniosa.",
						'body'        => "Michele è arrivato dall'Italia presso Estecapelli per sottoporsi a un trapianto di capelli con la tecnica Vita. Dopo un'attenta valutazione dell'area donatrice e delle zone interessate dal diradamento, è stato sviluppato un piano di trattamento personalizzato suddiviso in due sessioni. Durante la prima sessione è stato previsto il prelievo del massimo numero di innesti ottenibile in sicurezza. La priorità è stata assegnata alla zona frontale e alle tempie, dove i follicoli sono stati impiantati con maggiore densità, seguendo il disegno concordato durante la consulenza per ottenere un'attaccatura naturale e armoniosa. La seconda sessione permetterà di completare il trattamento delle aree rimanenti e migliorare ulteriormente la copertura complessiva. Al termine della procedura, Michele ha ricevuto tutte le indicazioni post-operatorie necessarie e ha iniziato il suo percorso di recupero con il supporto del team medico di Estecapelli.",
					),
					array(
						'key'         => 'nicola-l',
						'name'        => 'Nicola L.',
						...
						'technique'   => 'FUE',
						'rating'      => 5,
						'video_id'    => '5pA40DJuW9M',
						'poster'      => $img( 'it/nicola-l.jpg' ),
						'poster_pos'  => 'center 30%',
						'photo'       => $img( 'it/nicola-l.jpg' ),
						'photo_pos'   => 'center 30%',
						'pre_title'   => "Attaccatura frontale ricostruita con densità equilibrata.",
						'body'        => "Nicola è arrivato dall'Italia presso Estecapelli per sottoporsi al suo trapianto di capelli. Dopo una consulenza medica dettagliata e un'analisi approfondita dei capelli, è stato creato un piano di trattamento personalizzato per ricostruire l'attaccatura frontale e aumentare la densità nella zona frontale e centrale del cuoio capelluto. L'intervento è stato pianificato attentamente in base alla struttura dei suoi capelli e alle sue esigenze a lungo termine, prestando particolare attenzione alla creazione di un'attaccatura naturale, a una densità equilibrata e a una corretta distribuzione degli innesti. Al termine della procedura, Nicola ha ricevuto tutte le istruzioni post-operatorie necessarie e ha iniziato il percorso di recupero sotto la supervisione del team medico di Estecapelli.",
					),
				),
			),
			'fr' => array(
				'eyebrow'  => "Histoires vraies",
				'headline' => "Leurs résultats parlent plus fort que n'importe quelle publicité.",
				'lead'     => "Écoutez, avec leurs propres mots, comment des patients du monde entier racontent leur expérience chez Estecapelli, de la première consultation au résultat à long terme.",
				'stories'  => array(
					array(
						'key'         => 'adan-l',
						'name'        => 'Adan L.',
						...
						'technique'   => 'DHI Vita',
						'rating'      => 5,
						'video_id'    => 'olwg-XRXuIw',
						'poster'      => $img( 'fr/adan-l.jpg' ),
						'poster_pos'  => 'center 30%',
						'photo'       => $img( 'fr/adan-l.jpg' ),
						'photo_pos'   => 'center 30%',
						'pre_title'   => "Ligne frontale redessinée pour un résultat naturel.",
						'body'        => "Adan est venu du Canada chez Estecapelli pour réaliser une greffe de cheveux avec la technique DHI Vita. Après une évaluation détaillée de la zone donneuse et des régions touchées par la perte de cheveux, un plan de traitement personnalisé a été établi en fonction de ses besoins. Le nombre de greffons à prélever a été déterminé pendant l'intervention, en tenant compte de la capacité de la zone donneuse. Une implantation plus dense a été planifiée au niveau de la ligne frontale afin d'améliorer sa définition et d'obtenir un résultat naturel, harmonieux et adapté aux traits du visage. Les follicules ont été implantés en respectant l'orientation naturelle des cheveux existants. À la fin de l'intervention, Adan a reçu toutes les consignes nécessaires pour la période postopératoire et a commencé son processus de récupération avec le suivi de l'équipe médicale d'Estecapelli.",
					),
					array(
						'key'         => 'alain-c',
						'name'        => 'Alain C.',
						...
						'technique'   => 'FUE Vita',
						'rating'      => 5,
						'video_id'    => 'dEtzRXgAk-A',
						'poster'      => $img( 'fr/alain-c.jpg' ),
						'poster_pos'  => 'center 30%',
						'photo'       => $img( 'fr/alain-c.jpg' ),
						'photo_pos'   => 'center 30%',
						'pre_title'   => "Ligne capillaire redessinée avec plus de densité.",
						'body'        => "Alain est venu de France chez Estecapelli pour réaliser une greffe de cheveux avec la technique FUE Vita. Après une évaluation détaillée de la zone donneuse et des zones touchées par la perte de cheveux, un plan de traitement personnalisé en deux séances a été établi. Lors de la première séance, le nombre maximal de greffons pouvant être prélevés en toute sécurité a été extrait. La priorité a été donnée à la zone frontale afin de redessiner la ligne capillaire et d'améliorer la densité, tout en respectant l'orientation naturelle des cheveux existants. Une deuxième séance a été planifiée afin de compléter le traitement des zones restantes et d'améliorer la couverture globale. Après l'intervention, Alain a reçu toutes les consignes postopératoires nécessaires et a commencé sa récupération avec le suivi de l'équipe médicale d'Estecapelli.",
					),
					array(
						'key'         => 'biagio-p',
						'name'        => 'Biagio P.',
						...
						'technique'   => 'FUE',
						'rating'      => 5,
						'video_id'    => 'VsgKJgTgbNA',
						'poster'      => $img( 'fr/biagio-p.jpg' ),
						'poster_pos'  => 'center 25%',
						'photo'       => $img( 'fr/biagio-p.jpg' ),
						'photo_pos'   => 'center 25%',
						'pre_title'   => "Ligne frontale reconstruite avec une meilleure densité.",
						'body'        => "Biagio est venu de France chez Estecapelli pour réaliser une greffe de cheveux avec la technique FUE. Après une évaluation détaillée de sa zone donneuse et de la région frontale touchée par la perte de cheveux, un plan de traitement personnalisé a été établi. Au cours de l'intervention, le nombre maximal de greffons pouvant être prélevés en toute sécurité a été extrait, en tenant compte de la qualité et de la disponibilité des follicules dans la zone donneuse. Les greffons ont ensuite été implantés dans la région frontale afin de reconstruire la ligne capillaire et d'améliorer la densité, tout en respectant l'orientation naturelle des cheveux. Après la procédure, Biagio a reçu toutes les consignes nécessaires pour la période postopératoire et a commencé sa récupération sous le suivi de l'équipe médicale d'Estecapelli.",
					),
					array(
						'key'         => 'dorian-g',
						'name'        => 'Dorian G.',
					...
					array(
						...
						'technique'   => 'FUE Vita',
						'rating'      => 5,
						'video_id'    => 'X_yRP5-EnI8',
						'poster'      => $img( 'fr/florian-g.jpg' ),
						'poster_pos'  => 'center 32%',
						'photo'       => $img( 'fr/florian-g.jpg' ),
						'photo_pos'   => 'center 32%',
						'pre_title'   => "Greffe de cheveux et de barbe pour une densité homogène.",
						'body'        => "Florian est venu de France chez Estecapelli pour réaliser une greffe de cheveux et de barbe avec la technique FUE Vita. Après une évaluation détaillée de ses cheveux, de sa zone donneuse et des zones clairsemées de sa barbe, un plan de traitement personnalisé a été établi. Les greffons ont été répartis sur l'ensemble de la partie supérieure du cuir chevelu, depuis la zone frontale jusqu'à la couronne, afin d'améliorer la densité générale et d'obtenir une couverture plus homogène. Une partie des follicules a également été implantée dans les zones localisées de la barbe présentant des espaces ou une densité insuffisante. Après l'intervention, Florian a reçu toutes les consignes postopératoires nécessaires et a commencé sa récupération sous le suivi de l'équipe médicale d'Estecapelli.",
					),
					array(
						'key'         => 'jean-marc-c',
						'name'        => 'Jean-Marc C.',
						...
						'technique'   => 'FUE',
						'rating'      => 5,
						'video_id'    => '5pLFMJfLe54',
						'poster'      => $img( 'fr/jean-marc-c.jpg' ),
						'poster_pos'  => 'center 30%',
						'photo'       => $img( 'fr/jean-marc-c.jpg' ),
						'photo_pos'   => 'center 30%',
						'pre_title'   => "Densité renforcée dans la zone centrale du cuir chevelu.",
						'body'        => "Jean-Marc est venu de France chez Estecapelli pour réaliser une nouvelle greffe de cheveux avec la technique FUE, après avoir déjà bénéficié d'une première intervention en 2019. À la suite d'une évaluation détaillée, un plan de traitement personnalisé a été établi en tenant compte de l'état actuel de sa zone donneuse. La zone donneuse étant limitée, l'intervention a été planifiée avec prudence afin de prélever le nombre maximal de greffons possible en toute sécurité, tout en préservant les follicules disponibles. La priorité a été donnée à la zone centrale du cuir chevelu, où les greffons ont été répartis de manière ciblée afin d'améliorer la densité et la couverture. À la fin de l'intervention, Jean-Marc a reçu toutes les consignes nécessaires pour la période postopératoire et a commencé son processus de récupération sous le suivi de l'équipe médicale d'Estecapelli.",
					),
					array(
						'key'         => 'victor-g',
						'name'        => 'Victor G.',
						...
						'technique'   => 'FUE Vita',
						'rating'      => 5,
						'video_id'    => 'CPRfCGi0fTk',
						'poster'      => $img( 'fr/victor-g.jpg' ),
						'poster_pos'  => 'center 35%',
						'photo'       => $img( 'fr/victor-g.jpg' ),
						'photo_pos'   => 'center 35%',
						'pre_title'   => "Ligne frontale dense en une seule séance.",
						'body'        => "Victor est venu de France chez Estecapelli pour réaliser une greffe de cheveux avec la technique FUE Vita. Après une évaluation détaillée de la zone donneuse et des différentes zones touchées par la perte de cheveux, un plan de traitement personnalisé a été établi selon ses attentes. À la demande du patient, l'intervention a été planifiée en une seule séance, avec le prélèvement du nombre maximal de greffons pouvant être extrait en toute sécurité. Une densité plus importante a été prévue au niveau de la ligne frontale afin de mieux encadrer le visage et d'obtenir un résultat naturel. Les greffons restants ont été répartis de manière homogène sur la partie supérieure du cuir chevelu jusqu'à la couronne, avec une densité moyenne adaptée à la capacité de la zone donneuse. Après l'intervention, Victor a reçu toutes les recommandations postopératoires nécessaires et a commencé sa récupération sous le suivi de l'équipe médicale d'Estecapelli.",
					),
				),
			),
			'pl' => array(
				'eyebrow'  => 'Prawdziwe historie',
				'headline' => 'Ich rezultaty mówią głośniej niż jakakolwiek reklama.',
				'lead'     => 'Posłuchaj, ich własnymi słowami, jak pacjenci z całego świata opisują swoje doświadczenia z Estecapelli — od pierwszej konsultacji po długoterminowy efekt.',
				'stories'  => array(
					array(
						'key'         => 'adrian-o',
						'name'        => 'Adrian O.',
						...
						'technique'   => 'FUE Vita',
						'rating'      => 5,
						'video_id'    => '3F8tG200Iqs',
						'poster'      => $img( 'pl/adrian-o.jpg' ),
						'poster_pos'  => 'center 28%',
						'photo'       => $img( 'pl/adrian-o.jpg' ),
						'photo_pos'   => 'center 28%',
						'pre_title'   => 'Zagęszczenie przedniej części głowy i naturalna linia włosów.',
						'body'        => 'Adrian przyjechał z Polski do kliniki Estecapelli, aby poddać się przeszczepowi włosów metodą FUE Vita. Po dokładnej ocenie obszaru dawczego oraz miejsc objętych przerzedzeniem opracowano indywidualny plan leczenia, podzielony na dwie sesje. Podczas pierwszego zabiegu zaplanowano pobranie maksymalnej liczby graftów, możliwej do bezpiecznego pozyskania z obszaru dawczego. Priorytetem było zagęszczenie przedniej części skóry głowy oraz poprawa wyglądu linii włosów, z zachowaniem naturalnego kierunku wzrostu i proporcji twarzy. Druga sesja została zaplanowana w celu uzupełnienia pozostałych obszarów i uzyskania bardziej równomiernego pokrycia. Po zabiegu Adrian otrzymał szczegółowe zalecenia pooperacyjne i rozpoczął proces rekonwalescencji pod opieką zespołu medycznego Estecapelli.',
					),
					array(
						'key'         => 'artur-c',
						'name'        => 'Artur C.',
						...
						'technique'   => 'FUE Vita',
						'rating'      => 5,
						'video_id'    => 'QdbOW48YFXk',
						'poster'      => $img( 'pl/artur-c.jpg' ),
						'poster_pos'  => 'center 25%',
						'photo'       => $img( 'pl/artur-c.jpg' ),
						'photo_pos'   => 'center 25%',
						'pre_title'   => 'Druga sesja z dodatkowym zagęszczeniem przedniej linii.',
						'body'        => 'Artur przyjechał z Polski do kliniki Estecapelli, aby poddać się drugiej sesji przeszczepu włosów metodą FUE Vita. Po dokładnej ocenie obszaru dawczego oraz efektów wcześniejszego zabiegu opracowano indywidualny plan leczenia. Podczas zabiegu pobrano maksymalną liczbę graftów możliwą do bezpiecznego pozyskania. Dodatkowe zagęszczenie wykonano w lewej części przedniej linii włosów, natomiast pozostałe grafty równomiernie rozmieszczono w górnej części skóry głowy, aby poprawić ogólną gęstość i uzyskać naturalne pokrycie. Po zakończeniu procedury Artur otrzymał szczegółowe zalecenia pooperacyjne i rozpoczął rekonwalescencję pod opieką zespołu medycznego Estecapelli.',
					),
					array(
						'key'         => 'damian-m',
						'name'        => 'Damian M.',
					...
					array(
						...
						'technique'   => 'FUE Vita',
						'rating'      => 5,
						'video_id'    => 'Qpv-NxhS0-w',
						'poster'      => $img( 'pl/kamil-b.jpg' ),
						'poster_pos'  => 'center 25%',
						'photo'       => $img( 'pl/kamil-b.jpg' ),
						'photo_pos'   => 'center 25%',
						'pre_title'   => 'Odbudowa przedniej linii włosów aż po koronę.',
						'body'        => 'Kamil przyjechał z Polski do kliniki Estecapelli, aby poddać się przeszczepowi włosów metodą FUE Vita. Po dokładnej ocenie obszaru dawczego oraz stopnia utraty włosów opracowano indywidualny plan leczenia podzielony na dwie sesje. Podczas pierwszego zabiegu zaplanowano pobranie maksymalnej liczby graftów możliwej do bezpiecznego pozyskania z obszaru dawczego. Implantację rozpoczęto od przedniej linii włosów, a następnie grafty rozmieszczono w kierunku tylnej części skóry głowy, obejmując obszar aż do środkowej części korony. Druga sesja została zalecona w celu uzupełnienia pozostałych obszarów i uzyskania bardziej równomiernej gęstości. Po zabiegu Kamil otrzymał szczegółowe zalecenia pooperacyjne i rozpoczął rekonwalescencję pod opieką zespołu medycznego Estecapelli.',
					),
					array(
						'key'         => 'lukasz-m',
						'name'        => 'Łukasz M.',
						...
						'technique'   => 'FUE Vita',
						'rating'      => 5,
						'video_id'    => 'r3kUxv1xwdY',
						'poster'      => $img( 'pl/lukasz-m.jpg' ),
						'poster_pos'  => 'center 40%',
						'photo'       => $img( 'pl/lukasz-m.jpg' ),
						'photo_pos'   => 'center 40%',
						'pre_title'   => 'Gęstsza przednia linia i naturalna oprawa twarzy.',
						'body'        => 'Łukasz przyjechał z Polski do kliniki Estecapelli, aby poddać się kolejnemu przeszczepowi włosów metodą FUE Vita. Po szczegółowej ocenie wcześniejszego zabiegu, obszaru dawczego oraz miejsc wymagających uzupełnienia przygotowano indywidualny plan leczenia. Podczas zabiegu zaplanowano pobranie maksymalnej liczby graftów możliwej do bezpiecznego pozyskania. Największy priorytet nadano przedniej linii włosów, gdzie wykonano gęstszą implantację w celu poprawy jej wyglądu i uzyskania naturalnej oprawy twarzy. Pozostałe grafty rozmieszczono bardziej równomiernie w górnej części skóry głowy oraz w kierunku korony, dostosowując ich liczbę do możliwości obszaru dawczego. Po zakończeniu procedury Łukasz otrzymał szczegółowe zalecenia pooperacyjne i rozpoczął rekonwalescencję pod opieką zespołu medycznego Estecapelli.',
					),
					array(
						'key'         => 'piotr-s',
						'name'        => 'Piotr S.',
						...
						'technique'   => 'FUE Vita',
						'rating'      => 5,
						'video_id'    => 'nsefvOOpZlo',
						'poster'      => $img( 'pl/piotr-s.jpg' ),
						'poster_pos'  => 'center 25%',
						'photo'       => $img( 'pl/piotr-s.jpg' ),
						'photo_pos'   => 'center 25%',
						'pre_title'   => 'Zagęszczenie środkowej części głowy i okolicy korony.',
						'body'        => 'Piotr przyjechał z Polski do kliniki Estecapelli, aby poddać się drugiej sesji przeszczepu włosów metodą FUE Vita. Po dokładnej ocenie rezultatów wcześniejszego zabiegu, obszaru dawczego oraz miejsc wymagających dodatkowego zagęszczenia opracowano indywidualny plan leczenia. Podczas zabiegu zaplanowano pobranie maksymalnej liczby graftów możliwej do bezpiecznego pozyskania. Przeszczepione mieszki włosowe rozmieszczono głównie w środkowej części skóry głowy oraz w okolicy korony, aby poprawić ogólną gęstość i uzyskać bardziej równomierne pokrycie. Dodatkowo uzupełniono miejscowe przerzedzenia pozostałe po pierwszej operacji. Po zakończeniu zabiegu Piotr otrzymał szczegółowe zalecenia pooperacyjne i rozpoczął rekonwalescencję pod opieką zespołu medycznego Estecapelli.',
					),
					array(
						'key'         => 'tomasz-t',
						'name'        => 'Tomasz T.',
						...
						'technique'   => 'FUE Vita',
						'rating'      => 5,
						'video_id'    => '5FzXkv3n36o',
						'poster'      => $img( 'pl/tomasz-t.jpg' ),
						'poster_pos'  => 'center 25%',
						'photo'       => $img( 'pl/tomasz-t.jpg' ),
						'photo_pos'   => 'center 25%',
						'pre_title'   => 'Najgęstsze wszczepienie w strefie numer 1.',
						'body'        => 'Tomasz przyjechał z Polski do kliniki Estecapelli, aby poddać się przeszczepowi włosów metodą FUE Vita. Po dokładnej ocenie obszaru dawczego oraz stopnia przerzedzenia w różnych częściach skóry głowy opracowano indywidualny plan zabiegu, dopasowany do jego potrzeb. Podczas procedury zaplanowano pobranie maksymalnej liczby graftów możliwej do bezpiecznego pozyskania. Najwyższy priorytet nadano obszarowi oznaczonemu numerem 1, gdzie wykonano najgęstsze wszczepienie. W strefie numer 2 grafty rozmieszczono w sposób bardziej równomierny, z umiarkowaną gęstością, natomiast w obszarze numer 3 zaplanowano lżejsze uzupełnienie, aby poprawić ogólne pokrycie i zachować naturalny efekt. Cały zabieg został zaplanowany z uwzględnieniem ogólnej harmonii oraz właściwego rozłożenia graftów. Po zakończeniu procedury Tomasz otrzymał szczegółowe zalecenia pooperacyjne i rozpoczął rekonwalescencję pod opieką zespołu medycznego Estecapelli.',
					),
				),
			),
			'pt' => array(
				'eyebrow'  => 'Histórias reais',
				'headline' => 'Os resultados deles falam mais alto do que qualquer anúncio.',
				'lead'     => 'Ouça, nas suas próprias palavras, como pacientes de todo o mundo descrevem a sua experiência na Estecapelli — da primeira consulta ao resultado a longo prazo.',
				'stories'  => array(
					array(
						'key'         => 'antonello-p',
						'name'        => 'Antonello P.',
						...
						'technique'   => 'DHI Vita',
						'rating'      => 5,
						'video_id'    => 'qIf4jRfYC7w',
						'poster'      => $img( 'pt/antonello-p.jpg' ),
						'poster_pos'  => 'center 30%',
						'photo'       => $img( 'pt/antonello-p.jpg' ),
						'photo_pos'   => 'center 30%',
						'pre_title'   => 'Cobertura densa da região frontal, sem rapar o cabelo.',
						'body'        => 'Antonello veio de Itália até à Estecapelli para realizar o seu transplante capilar com a técnica DHI Vita, sem necessidade de rapar completamente o cabelo. Após uma avaliação detalhada da área doadora e das diferentes zonas afetadas pela queda de cabelo, foi preparado um plano de tratamento personalizado. Durante o procedimento, foi extraído o número máximo de enxertos possível em segurança. As zonas identificadas com os números 1 e 2 receberam prioridade, com uma implantação mais densa para melhorar a cobertura da região frontal e da parte superior do couro cabeludo. Na zona número 3, correspondente à coroa, os enxertos foram distribuídos de forma homogénea para proporcionar uma cobertura equilibrada e natural. Após o procedimento, Antonello recebeu todas as orientações pós-operatórias necessárias e iniciou a sua recuperação com o acompanhamento da equipa médica da Estecapelli.',
					),
					array(
						'key'         => 'daniel-f',
						'name'        => 'Daniel F.',
						...
						'technique'   => 'Vita',
						'rating'      => 5,
						'video_id'    => 'bfkAbaK8vJk',
						'poster'      => $img( 'pt/daniel-f.jpg' ),
						'poster_pos'  => 'center 30%',
						'photo'       => $img( 'pt/daniel-f.jpg' ),
						'photo_pos'   => 'center 30%',
						'pre_title'   => 'Linha frontal densa para enquadrar melhor o rosto.',
						'body'        => 'Daniel veio de Espanha até à Estecapelli para realizar o seu transplante capilar com a técnica Vita. Após uma avaliação detalhada da área doadora e da extensão da zona com perda de cabelo, foi definido um plano de tratamento personalizado, de acordo com as suas necessidades. Durante o procedimento, foi planeada a extração do número máximo de enxertos possível em segurança. Como a área doadora era mais limitada e a zona a tratar era bastante ampla, a prioridade foi concentrar os folículos na região frontal, onde foi realizada uma implantação mais densa para melhorar a linha capilar e criar um enquadramento mais forte e natural do rosto. Os enxertos foram distribuídos de forma estratégica para obter o melhor aproveitamento possível da área doadora e um resultado equilibrado. Após o procedimento, Daniel recebeu todas as orientações pós-operatórias necessárias e iniciou a sua recuperação com o acompanhamento da equipa médica da Estecapelli.',
					),
					array(
						'key'         => 'diogo-s',
						'name'        => 'Diogo S.',
						...
						'technique'   => 'FUE Vita',
						'rating'      => 5,
						'video_id'    => 'XdAm8xL15Fs',
						'poster'      => $img( 'pt/diogo-s.jpg' ),
						'poster_pos'  => 'center 28%',
						'photo'       => $img( 'pt/diogo-s.jpg' ),
						'photo_pos'   => 'center 28%',
						'pre_title'   => 'Definição reforçada nos primeiros centímetros da linha capilar.',
						'body'        => 'Diogo veio de Portugal até à Estecapelli para realizar o seu transplante capilar com a técnica FUE Vita. Após uma avaliação detalhada da área doadora e da zona afetada pela queda de cabelo, foi definido um plano de tratamento personalizado de acordo com as suas necessidades. Durante o procedimento, foi planeada a extração do número de enxertos necessário para alcançar a melhor cobertura possível. A prioridade foi dada à região frontal, especialmente aos primeiros centímetros da linha capilar, onde foi prevista uma implantação mais densa para melhorar a definição e proporcionar um resultado natural. Os folículos foram distribuídos de forma estratégica para reforçar a parte frontal e criar uma densidade equilibrada, respeitando a estrutura natural do cabelo. Após o procedimento, Diogo recebeu todas as orientações pós-operatórias necessárias e iniciou a sua recuperação com o acompanhamento da equipa médica da Estecapelli.',
					),
					array(
						'key'         => 'jhonne-q',
						'name'        => 'Jhonne Q.',
					...
					array(
						...
						'technique'   => 'DHI Vita',
						'rating'      => 5,
						'video_id'    => '7C8iR1tZtnU',
						'poster'      => $img( 'pt/jose-miguel-f.jpg' ),
						'poster_pos'  => 'center 30%',
						'photo'       => $img( 'pt/jose-miguel-f.jpg' ),
						'photo_pos'   => 'center 30%',
						'pre_title'   => 'Maior densidade na região frontal e no topo da cabeça.',
						'body'        => 'José Miguel veio de Portugal até à Estecapelli para realizar o seu transplante capilar com a técnica DHI Vita. Após uma avaliação detalhada da área doadora e das zonas afetadas pela queda de cabelo, foi elaborado um plano de tratamento personalizado. Durante o procedimento, foi planeada a extração do número máximo de enxertos possível em segurança. A prioridade foi dada à região frontal e à parte superior do couro cabeludo, onde os folículos foram implantados com maior densidade para melhorar a cobertura e proporcionar um resultado mais natural e equilibrado. A distribuição dos enxertos foi cuidadosamente planeada para respeitar a direção natural do cabelo e manter uma transição harmoniosa entre as diferentes áreas. Após o procedimento, José Miguel recebeu todas as orientações pós-operatórias necessárias e iniciou a sua recuperação com o acompanhamento da equipa médica da Estecapelli.',
					),
					array(
						'key'         => 'wellington-p',
						'name'        => 'Wellington P.',
						...
						'technique'   => 'FUE Vita',
						'rating'      => 5,
						'video_id'    => 'BlRc3wCMsQg',
						'poster'      => $img( 'pt/wellington-p.jpg' ),
						'poster_pos'  => 'center 30%',
						'photo'       => $img( 'pt/wellington-p.jpg' ),
						'photo_pos'   => 'center 30%',
						'pre_title'   => 'Reforço frontal com acompanhamento dermatológico.',
						'body'        => 'Wellington veio de Inglaterra até à Estecapelli para realizar o seu transplante capilar com a técnica FUE Vita. Após uma avaliação detalhada da área doadora e das zonas afetadas pela queda de cabelo, foi elaborado um plano de tratamento personalizado. Durante o procedimento, foi planeada a extração do número máximo de enxertos possível em segurança. A implantação começou na região frontal e avançou para a parte superior do couro cabeludo, de acordo com a quantidade de folículos disponíveis e com a capacidade da área doadora. Como foram observados sinais de dermatite nas zonas doadora e recetora, Wellington foi também orientado a realizar um acompanhamento dermatológico. Após o procedimento, recebeu todas as recomendações pós-operatórias necessárias e iniciou a sua recuperação com o acompanhamento da equipa médica da Estecapelli.',
					),
					array(
						'key'         => 'antonio-m',
						'name'        => 'António M.',
