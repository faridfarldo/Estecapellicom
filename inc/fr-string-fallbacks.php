...
function estecapelli_fr_gettext_fallback( $translation, $text, $domain ) {
	...
	$strings = array(
		...
		'Research, results and recovery — written by our team.' => 'Recherche, résultats et convalescence — écrits par notre équipe.',
		'View all articles'                       => 'Voir tous les articles',
		'Write the first article'                 => 'Rédiger le premier article',
		'No articles have been published yet. New posts will appear here as soon as your team publishes them.' => 'Aucun article n’a encore été publié. Les nouveaux articles apparaîtront ici dès que votre équipe les publiera.',
		...
		'Keep reading'                            => 'Poursuivez votre lecture',
		'Share'                                   => 'Partager',
		...
		'Please complete the security check and try again.' => 'Veuillez effectuer le contrôle de sécurité et réessayer.',
		'The security check is temporarily unavailable. Please try again.' => 'Le contrôle de sécurité est temporairement indisponible. Veuillez réessayer.',
		'Please refresh the page and submit the form again.' => 'Veuillez actualiser la page et renvoyer le formulaire.',
