...
function estecapelli_pl_gettext_fallback( $translation, $text, $domain ) {
	...
	if ( null === $strings ) {
		$strings = array(
			...
			'Please complete the security check and try again.' => 'Ukończ weryfikację bezpieczeństwa i spróbuj ponownie.',
			'The security check is temporarily unavailable. Please try again.' => 'Weryfikacja bezpieczeństwa jest chwilowo niedostępna. Spróbuj ponownie.',
			'Please refresh the page and submit the form again.' => 'Odśwież stronę i ponownie wyślij formularz.',
			'Too many requests. Please wait a few minutes and try again.' => 'Zbyt wiele żądań. Odczekaj kilka minut i spróbuj ponownie.',
