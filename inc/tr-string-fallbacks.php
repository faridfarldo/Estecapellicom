...
function estecapelli_tr_gettext_fallback( $translation, $text, $domain ) {
	...
	if ( null === $strings ) {
		$strings = array(
			...
			'Keep reading' => 'Okumaya devam edin',
			'Share' => 'Paylaş',
			...
			'Please complete the security check and try again.' => 'Güvenlik doğrulamasını tamamlayıp tekrar deneyin.',
			'The security check is temporarily unavailable. Please try again.' => 'Güvenlik doğrulaması geçici olarak kullanılamıyor. Lütfen tekrar deneyin.',
			'Please refresh the page and submit the form again.' => 'Lütfen sayfayı yenileyip formu tekrar gönderin.',
			'Too many requests. Please wait a few minutes and try again.' => 'Çok fazla istek gönderildi. Lütfen birkaç dakika bekleyip tekrar deneyin.',
