...
class Estecapelli_Walker_Nav_Menu extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
		...
		if ( $has_children && 0 === $depth ) {
			$item_output .= '<svg class="site-nav__chevron" viewBox="0 0 12 12" aria-hidden="true" focusable="false"><path d="M2 4 L6 8 L10 4" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>';
		}
		$item_output .= '</a>';
