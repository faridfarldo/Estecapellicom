			...
			array(
				...
				'sections' => array(
					...
					array(
						...
						'items'         => array(
							array( 'icon' => 'hair',         'eyebrow' => __( 'Stage 1', 'estecapelli' ), 'title' => __( 'Harvesting Hair Follicles', 'estecapelli' ),         'body' => '<p>' . esc_html__( 'Healthy grafts are extracted one by one from the safe donor area at the back and sides of the scalp, where hair is genetically resistant to shedding. Our surgeons use ultra-fine micromotor punches to lift each follicular unit without cutting or stitching, so the donor area heals quickly and leaves no linear scar.', 'estecapelli' ) . '</p>' ),
							array( 'icon' => 'atom',         'eyebrow' => __( 'Stage 2', 'estecapelli' ), 'title' => __( 'Strengthening in Exosome Solution', 'estecapelli' ), 'body' => '<p>' . esc_html__( 'Immediately after extraction, the grafts are kept in a specially formulated exosome solution rather than an ordinary holding fluid. These regenerative signalling particles nourish and protect the follicles outside the body, reduce the stress of the waiting period, and prepare them to survive and thrive once transplanted.', 'estecapelli' ) . '</p>' ),
							array( 'icon' => 'target',       'eyebrow' => __( 'Stage 3', 'estecapelli' ), 'title' => __( 'Preparing the Transplantation Area', 'estecapelli' ), 'body' => '<p>' . esc_html__( 'The recipient area is mapped according to your natural hairline and facial proportions, then opened with sapphire-tipped instruments. These smooth, precise micro-channels control the exact depth, angle and direction of every follicle, which is what gives the final result its natural density and undetectable look.', 'estecapelli' ) . '</p>' ),
							array( 'icon' => 'check-circle', 'eyebrow' => __( 'Stage 4', 'estecapelli' ), 'title' => __( 'Transplantation of the Follicles', 'estecapelli' ), 'body' => '<p>' . esc_html__( 'The exosome-strengthened follicles are placed into the prepared channels one by one, respecting the natural growth pattern of the surrounding hair. Careful attention to angle, orientation and spacing ensures balanced coverage and a result that looks and behaves like your own hair as it grows in.', 'estecapelli' ) . '</p>' ),
							array( 'icon' => 'hands-heart',  'eyebrow' => __( 'Stage 5', 'estecapelli' ), 'title' => __( 'Healing Process', 'estecapelli' ),                  'body' => '<p>' . esc_html__( 'Most patients return home the same day with detailed aftercare instructions and a personal recovery plan. Mild redness and scabbing settle within the first week, the transplanted hairs shed before regrowing, and our team stays in contact throughout — guiding you from the first wash to visible new growth from around month three and full results by month twelve.', 'estecapelli' ) . '</p>' ),
						),
					),
				...
				'sections' => array(
					...
					array(
						...
						'items'         => array(
							...
							array( 'question' => __( 'How long do the results last?', 'estecapelli' ), 'answer' => '<p>' . esc_html__( 'The results of mesotherapy can be long-lasting, especially when combined with a healthy lifestyle and proper hair care. However, as the treatment supports and stimulates existing hair follicles rather than permanently stopping the underlying causes of hair loss, maintenance sessions may be recommended depending on your individual condition. Periodic treatments help preserve hair density, maintain scalp health and support stronger, healthier hair growth over time.', 'estecapelli' ) . '</p>' ),
						),
					),
			...
			array(
				...
				'sections' => array(
					...
					array(
						...
						'media_type'    => 'image',
						'image'         => '',
						'image_url'     => get_template_directory_uri() . '/assets/images/treatments/graft-extraction.webp',
						'video_id'      => '',
					),
			...
			array(
				...
				'sections' => array(
					...
					array(
						...
						'media_type'    => 'image',
						'image'         => '',
						'image_url'     => get_template_directory_uri() . '/assets/images/treatments/scalp-implant.webp',
						'video_id'      => '',
					),
					...
					array(
						...
						'image'         => '',
						'image_url'     => get_template_directory_uri() . '/assets/images/treatments/scalp-implant-macro.webp',
						'image_position' => 'right',
						'cta'           => array( 'label' => '', 'url' => '' ),
					),
			...
			array(
				...
				'sections' => array(
					...
					array(
						...
						'lead'          => __( 'A four-stage protocol that integrates seamlessly into your Sapphire FUE or DHI transplant. Swipe through the stages below.', 'estecapelli' ),
						'items'         => array(
							array( 'icon' => 'medical-plus', 'eyebrow' => __( 'Stage 1', 'estecapelli' ), 'title' => __( 'Choose Between FUE and DHI', 'estecapelli' ), 'body' => '<p>' . esc_html__( 'Both Sapphire FUE and DHI can be seamlessly combined with the VITA Treatment Protocol. You can choose between these two methods based on your hair structure, donor area and goals, with our medical team helping you select the most suitable approach.', 'estecapelli' ) . '</p>' ),
							array( 'icon' => 'atom',         'eyebrow' => __( 'Stage 2', 'estecapelli' ), 'title' => __( 'Microneedling & Nutrient Serum', 'estecapelli' ), 'body' => '<p>' . esc_html__( 'Microchannels are created with a dermaroller massage tool, and a highly concentrated serum of vitamins, amino acids, growth factors and minerals is applied to boost blood circulation. The donor area is ideally prepared for smooth, well-fed harvesting, while the recipient area is nourished with a concentrated vitamin complex that the scalp absorbs far more effectively thanks to the micro-channels.', 'estecapelli' ) . '</p>' ),
							array( 'icon' => 'hands-heart',  'eyebrow' => __( 'Stage 3', 'estecapelli' ), 'title' => __( 'Cold-Vapour Serum on Grafts', 'estecapelli' ),  'body' => '<p>' . esc_html__( 'The same nourishing serum is mixed with saline in the graft-harvesting tray and applied to the harvested grafts using a cold-vapour method. This is the most critical window — while follicles are outside the body — so protecting them here prevents deterioration, maximises survival and increases their post-transplantation regrowth potential.', 'estecapelli' ) . '</p>' ),
							array( 'eyebrow' => __( 'Stage 4', 'estecapelli' ), 'title' => __( 'PRP After the Procedure', 'estecapelli' ), 'body' => '<p>' . esc_html__( 'PRP (Platelet-Rich Plasma) is applied as the final stage of the treatment — a regenerative therapy performed immediately after your hair transplant to support healing and improve the overall result. A small sample of your blood is collected and processed in a centrifuge to separate the platelet-rich plasma, which contains a high concentration of natural growth factors. The PRP is then carefully injected into the treated areas of the scalp, where it helps accelerate tissue repair, reduce inflammation, improve blood circulation and create an optimal environment for the newly transplanted grafts. By stimulating the healing process and nourishing the follicles, PRP contributes to stronger graft retention, faster recovery and healthier, thicker hair growth.', 'estecapelli' ) . '</p>', 'image_url' => 'https://estecapelli.com/wp-content/uploads/2026/06/prp.webp' ),
						),
					),
			...
			array(
				...
				'sections' => array(
					...
					array(
						...
						'media_type'    => 'image',
						'image'         => '',
						'image_url'     => get_template_directory_uri() . '/assets/images/treatments/eyebrow-transplant.webp',
						'video_id'      => '',
					),
			...
			array(
				...
				'sections' => array(
					...
					array(
						...
						'media_type'    => 'image',
						'image'         => '',
						'image_url'     => get_template_directory_uri() . '/assets/images/treatments/beard-transplant.webp',
						'video_id'      => '',
					),
					...
					array(
						...
						'image'         => '',
						'image_url'     => get_template_directory_uri() . '/assets/images/treatments/beard-placement.webp',
						'image_position' => 'left',
						'cta'           => array( 'label' => '', 'url' => '' ),
					),
